...
export const LOCK_BID_WINDOW = 7_001;
export const LOCK_STALE_DRIVERS = 7_002;
export const LOCK_RADIUS_EXPANSION = 7_003;
...
export async function withAdvisoryLock<T>(
  ...
  try {
    const tryRes = await client.query<{ locked: boolean }>(
